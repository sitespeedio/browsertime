...
import static net.browsertime.tool.run.Browser.chrome;
import static net.browsertime.tool.run.Browser.firefox;
import static net.browsertime.tool.run.Browser.ie;
