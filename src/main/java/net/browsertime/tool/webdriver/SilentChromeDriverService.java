...
/**
 * NOTE
 * This file is a copy of org.openqa.selenium.chrome.ChromeDriverService with the addition of the "silent" switch.
 ...
 */
public class SilentChromeDriverService extends DriverService {
   ...
   */
  private SilentChromeDriverService(File executable, int port, ImmutableList<String> args,
                                    ImmutableMap<String, String> environment) throws IOException {
    super(executable, port, args, environment);
  }

  /**
   * Configures and returns a new {@link SilentChromeDriverService} using the default configuration. In
   ...
   */
  public static SilentChromeDriverService createDefaultService() {
  ...
  /**
   * Builder used to configure new {@link SilentChromeDriverService} instances.
   */
  public static class Builder {
    ...
    /**
     * Configures the driver server for silent mode.
     *
     ...
     */
    public SilentChromeDriverService build() {
      if (port == 0) {
      ...
      try {
        ...
        return new SilentChromeDriverService(exe, port, argsBuilder.build(), environment);
