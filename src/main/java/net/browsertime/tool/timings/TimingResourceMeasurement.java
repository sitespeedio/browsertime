...
public class TimingResourceMeasurement extends TimingMark implements Comparable<TimingResourceMeasurement> {
    ...
    public TimingResourceMeasurement(String name, double startTime,
                                     String initiatorType, double duration,
                                     double redirectStart, double redirectEnd,
                                     double fetchStart,
                                     double domainLookupStart, double domainLookupEnd,
                                     double connectStart, double connectEnd,
                                     double secureConnectionStart,
                                     double requestStart,
                                     double responseStart, double responseEnd) {
