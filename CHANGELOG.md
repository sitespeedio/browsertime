...
* Click the Android power button at the start of each test (instead if the home button [#1447](https://github.com/sitespeedio/browsertime/pull/1447).
