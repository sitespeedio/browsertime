...
let Engine = require('../').Engine,
  ...
  DatabaseManager = require('../lib/support/databaseManager'),
...
engine.start()
    ...
    .then(function(result) {
      ...
      if(options.mongo.URI){
        const databaseManager = new DatabaseManager(options);
        return databaseManager.saveToMongo(result).then(() => {
          log.info('Wrote data to Mongo');
          return result;
        });
      } else {
