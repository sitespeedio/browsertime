...
export class Chromium {
  ...
  async afterEachURL(runner, index, result) {
    ...
    if (this.collectTracingEvents) {
      ...
      result.renderInformation = { recalculateStyle: {} };
      ...
      if (fcpEvent) {
        ...
        result.renderInformation.recalculateStyle.beforeFCP = beforeFCP;
      }
      ...
      if (lcpEvent) {
        ...
        result.renderInformation.recalculateStyle.beforeLCP = beforeLCP;
      }
