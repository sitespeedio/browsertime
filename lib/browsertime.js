			...
			function(err) {
				...
				driver.wait(function() {
					...
					pageLoadTimeout
						...
						var promises = [];
						self._populatePromises(driver, self.builtinScripts.dynamic, promises, false, false);
						self._populatePromises(driver, self.customScripts.dynamic, promises, false, true);

						if (iteration === 1) {
							self._populatePromises(driver, self.builtinScripts.static, promises, true, false);
