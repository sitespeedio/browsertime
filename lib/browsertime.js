...
Browsertime.prototype._getFormattedResult = function(options) {
  ...
  this.result.default.forEach(function(run) {
    Object.keys(self.defaultScripts).forEach(function(scriptName) {
      ...
      // special handling for navigation timing
      if (scriptName === 'navigationTiming') {
        Object.keys(run[scriptName]).forEach(function(navTime) {
        stats.setupStatistics(defaultData, run[scriptName], navTime);
        });
      }
    });
