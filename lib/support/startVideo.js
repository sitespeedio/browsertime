...
function getArgs(testUrl, data, options, dataDir) {
  data.dir = dataDir;
    ...
    return runner.runWithDriver((driver) => {
      ...
      return driver.get('data:text/html;charset=utf-8,')
        ...
        .then(() => {
          ...
          return storageManager.createSubDataDir('video');
        })
        .then((dataDir) => {
          startFFMpeg(getArgs(testUrl, data, options, dataDir), data, function() {
