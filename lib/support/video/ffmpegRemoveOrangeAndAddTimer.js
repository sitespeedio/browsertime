...
module.exports = {
    run(videoPath, newStart, outputFile, metrics, options) {
        ...
        const speedIndex = "drawtext=enable='between(t," + (Number(metrics.SpeedIndex) / 1000) + ",30)':x=(w-tw)/2: y=H-96:fontcolor=white:fontsize=32:box=1:boxcolor=0x000000AA:text='SpeedIndex " +
            metrics.SpeedIndex + "'";
