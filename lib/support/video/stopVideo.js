...
const visualMetrics = require('./visualMetrics'),
    ...
    ffmpegRemoveOrangeAndAddText= require('./ffmpegRemoveOrangeAndAddText').run,
    path = require('path');
                ...
                then(() => {
                    if (context.options.experimental.removeVideo) {
                        ...
                        return ffprobe.run(recording.filePath).then((ffProbeJson) => {
                            ...
                            return ffmpegRemoveOrangeAndAddText(recording.filePath, newStart, tmpFile, context.results.visualMetrics, context.options);
