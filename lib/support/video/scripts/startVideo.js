        ...
        driver
          ...
          .then(videoDir => {
            ...
            if (process.platform === 'darwin' && !context.options.xvfb) {
              ...
              const originChrome = '0,106';
              const offsetFirefox = { x: 0, y: 168 };
              // Without the automated infobar introduced in 65
              // https://github.com/sitespeedio/browsertime/issues/489
              // The old offset was 66, so the new "bar" adds 50 px
              const offsetChrome = { x: 0, y: 106 };
