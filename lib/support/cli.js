  ...
  let validated = yargs
    ...
    */
    ...
    .option('percentiles', {
      ...
      describe:
        'The percentile values within the data browsertime will calculate and report. Use it multiple times to add multiple percentiles: --percentiles 0 --percentiles 10 --percentiles 90'
    })
    .option('decimals', {
      type: 'number',
      default: 0,
