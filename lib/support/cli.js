...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('videoParams.combine', {
      ...
      default: false,
      describe:
        'Combine all script/URLs with the tested URL in the video. Turn this on and you will record the all scripts but you will not get any Visual Metrics. Use this when you want to test that your full user journey works.',
      group: 'video'
    })
