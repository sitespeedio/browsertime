...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('scriptNavigation', {
      describe:
        'Selenium script used to navigate to a URL that you want to test. Use this to test more complicated flows (login, add things to your cart etc). See XXX for details.'
    })
    .option('userAgent', {
