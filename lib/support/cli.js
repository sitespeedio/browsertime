...
export function parseCommandLine() {
  ...
  let validated = yargsInstance
    ...
    .option('android.usbPowerTestingPort', {
      alias: 'androidUsbPowerPort',
      type: 'number',
      default: 2121,
      describe:
        'Used to specify the port used for the power usage collection server when ' +
        'gathering it using usb-power-profiling.',
      group: 'android'
    })
