...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('cookie', {
      describe:
        'Cookie that will be added to the request. Add multiple instances to add multiple request cookies. This is Chrome only at the moment at the moment. Use the following format cookieName=cookieValue'
    })
    .option('block', {
      describe:
