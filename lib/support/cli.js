...
module.exports.parseCommandLine = function parseCommandLine() {
  let argv = yargs
    ...
    .option('connectivity.engine', {
      default: 'tsproxy',
      choices: ['tc','tsproxy','throttled'],
      describe: 'The engine for connectivity. TSProxy needs Python 2.7. TC (Linux Traffic Control) needs tc work but will only setup upload and latency. Use throttled if you set the connectivity outside of Browsertime.',
      group: 'connectivity'
    })
    .option('preScript', {
