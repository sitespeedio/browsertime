...
module.exports.parseCommandLine = function parseCommandLine() {
  let argv = yargs
    ...
    .option('chrome.collectTraceCategoriesLog', {
      type: 'boolean',
      describe: 'Collect Chromes traceCategories log to disk.',
      group: 'chrome'
    })
    ...
    .option('chrome.collectChromePerflog', {
      type: 'boolean',
      describe: 'Collect Chromes performance log with Network.* events and save to disk.',
      group: 'chrome'
    })
    .option('chrome.collectChromeNetlog', {
      type: 'boolean',
      describe: 'Collect Chromes network log and save to disk.',
      group: 'chrome'
    })
