  ...
  let validated = yargsInstance
    ...
    */
    ...
    .option('extraTrace', {
      type: 'boolean',
      describe:
        'Make one extra run that collects the trace log. For Chrome it will collect the timeline trace, for Firefox it will get the Geckoprofiler trace. This means you do not need to get the trace for all runs and can skip the overhead it produces.'
    })
    .option('video', {
      type: 'boolean',
      describe:
