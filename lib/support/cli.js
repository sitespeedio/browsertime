...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('scriptNavigation', {
      describe:
        'Selenium script used to navigate to a URL that you want to test. Use this to test more complicated flows (login, add items to your cart etc). See https://github.com/sitespeedio/browsertime#script-navigation for details.'
    })
    .option('userAgent', {
