...
module.exports.parseCommandLine = function parseCommandLine() {
  let validated = yargs
    ...
    .option('firefox.beta', {
      describe: 'Use Firefox Beta. Will ovverride firefox.binaryPath',
      type: 'boolean',
      group: 'firefox'
    })
    .option('firefox.auroa', {
      describe: 'Use Firefox Developer. Will ovverride firefox.binaryPath',
      type: 'boolean',
      group: 'firefox'
    })
  ...
  if (
    argv.firefox &&
    (argv.firefox.nightly || argv.firefox.beta || argv.firefox.aurora)
  ) {
