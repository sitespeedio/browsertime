 ...
 * The category name is specified by the category argument. If no category is passed, single js
 * files will be put into the category 'custom', for directories the category name will be taken
...
function findAndParseScripts(root, category) {
  ...
  function parseDirectory(dirPath) {
    const categoryName = category || path.basename(dirPath);
