...
const defaultPageCompleteCheck =
  'return (function() {try { if (performance.now() > ((performance.timing.loadEventEnd - performance.timing.navigationStart) + 2000)) {return true;} else return false;} catch(e) {return true;}})()';
const defaults = {
  timeouts: {
    browserStart: 60000,
    pageLoad: 300000,
