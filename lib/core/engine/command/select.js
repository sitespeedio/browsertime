...
class Select {
   ...
   */
  async selectByValue(selectId, value) {
    try {
   ...
   * @throws Will throw an error if the select is not found
   */
  async selectByIndex(selectId, index) {
    try {
   ...
   * @throws Will throw an error if the select is not found
   */
  async selectByNameIndex(selectName, index) {
    try {
   ...
   * @throws Will throw an error if the select is not found.
   */
  async getSelectedValue(selectId) {
    try {
