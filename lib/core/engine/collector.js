...
export class Collector {
  constructor(url, storageManager, options) {
    ...
    this.collectChromeTimeline = options.chrome && (options.chrome.timeline || options.chrome.timelineRecordingType === 'custom');
    this.allStats = {};
    this.allResults = {};
    this.aliasAndUrl = {};
  ...
  async perIteration(allData, index) {
    for (let data of allData) {
      ...
      if (this.options.chrome && (this.options.chrome.timeline || this.options.chrome.timelineRecordingType === 'custom')) {
