  ...
  async run(navigationScript, index) {
    ...
    try {
      ...
      if (isAndroidConfigured(options)) {
        ...
        batteryTemperature.start = await commands.android.getTemperature();
      }
      ...
      if (isAndroidConfigured(options)) {
        batteryTemperature.stop = await commands.android.getTemperature();
        await commands.android.removeDevtoolsFw();
      }
