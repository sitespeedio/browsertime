      ...
      if (recordVideo && !options.videoParams.debug) {
        ...
        for (let myVideo of videos) {
          try {
            ...
            videoMetrics.visualMetrics.VisualProgress = util.jsonifyVisualProgress(
              videoMetrics.visualMetrics.VisualProgress
            );
            videoMetrics.visualMetrics.ContentfulSpeedIndexProgress = util.jsonifyVisualProgress(
              videoMetrics.visualMetrics.ContentfulSpeedIndexProgress
            );
            videoMetrics.visualMetrics.PerceptualSpeedIndexProgress = util.jsonifyVisualProgress(
              videoMetrics.visualMetrics.PerceptualSpeedIndexProgress
            );
            ...
            if (
              ...
              try {
                ...
                videoMetrics.visualMetrics.VisualProgress = util.adjustVisualProgressTimestamps(
                  videoMetrics.visualMetrics.VisualProgress,
                  geckoProfile.meta.startTime,
                  firstFrameStartTime
                );
                videoMetrics.visualMetrics.ContentfulSpeedIndexProgress = util.adjustVisualProgressTimestamps(
                  videoMetrics.visualMetrics.ContentfulSpeedIndexProgress,
                  geckoProfile.meta.startTime,
                  firstFrameStartTime
                );
                videoMetrics.visualMetrics.PerceptualSpeedIndexProgress = util.adjustVisualProgressTimestamps(
                  videoMetrics.visualMetrics.PerceptualSpeedIndexProgress,
                  geckoProfile.meta.startTime,
                  firstFrameStartTime
                );
