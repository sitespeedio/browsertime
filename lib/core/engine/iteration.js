...
const Text = require('./help/text.js');
const Click = require('./help/click.js');
const Wait = require('./help/wait.js');
const Measure = require('./help/measure.js');
