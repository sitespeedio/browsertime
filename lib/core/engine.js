...
const Promise = require('bluebird'),
  ...
  startVideoAndroid = require('../support/video/scripts/startVideoAndroid'),
  stopVideo = require('../support/video/scripts/stopVideo'),
  stopVideoAndroid = require('../support/video/scripts/stopVideoAndroid'),
  ...
  extensionSetup = require('../support/extensionSetup'),
...
class Engine {
  ...
  run(url, scriptsByCategory, asyncScriptsByCategory) {
    ...
    if (options.cacheClearRaw || options.requestheader || options.block) {
      options.preScript.push(extensionSetup);
    }
