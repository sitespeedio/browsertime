...
module.exports.configureBuilder = function(builder, options) {
  ...
  if (chromeConfig.addTraceCategory) {
    timelineTraceCategories.push.apply(timelineTraceCategories, util.toArray(chromeConfig.addTraceCategory));
  }

  if (chromeConfig.dumpTraceCategoriesLog) {
    perfLogConf.traceCategories = timelineTraceCategories.join(',');
  }
