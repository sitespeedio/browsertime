...
module.exports.configureBuilder = function(builder, options) {
  ...
  // same config as Lighthouse
  chromeOptions.setPerfLoggingPrefs({enableNetwork: true, enablePage: true, traceCategories: '-*,toplevel,blink.console,blink.user_timing,benchmark,loading,latencyInfo,devtools.timeline,disabled-by-default-devtools.timeline,disabled-by-default-devtools.timeline.frame,disabled-by-default-devtools.timeline.stack'});
