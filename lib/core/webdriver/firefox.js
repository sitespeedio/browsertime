...
module.exports.configureBuilder = function(builder, options) {
  ...
  if (options.firefox && options.firefox.preference) {
    const userPrefs = Array.isArray(options.firefox.preference) ? options.firefox.preference : [options.firefox.preference];
